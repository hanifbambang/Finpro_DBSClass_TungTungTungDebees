import { PokemonModel, MoveModel, TrainerModel, redis } from "./db.js";
...
export const seedData = async () => {
  ...
  for (const m of moves) {
    await MoveModel.updateOne({ id: m.id }, m, { upsert: true });
  }

  // ── Seed Pokémon from PokeAPI ─────────────────────────────────────────────
  try {
    ...
    for (let i = 0; i < results.length; i += CHUNK_SIZE) {
      ...
      await Promise.all(
        chunk.map(async (p: any) => {
          ...
          await PokemonModel.updateOne({ id: pData.id }, pData, {
            upsert: true,
          });
        })
      );
    ...
    const fallbackPokemon = [
      { id: "25",  name: "Pikachu",   hp: "35", attack: "55", defense: "40", spAtk: "50", spDef: "50", speed: "90",  types: "Electric",     sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/25.png",  moves: "Thunderbolt,Quick Attack", description: "" },
      { id: "1",   name: "Bulbasaur", hp: "45", attack: "49", defense: "49", spAtk: "65", spDef: "65", speed: "45",  types: "Grass,Poison",  sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png",   moves: "Razor Leaf,Tackle",       description: "" },
      { id: "4",   name: "Charmander",hp: "39", attack: "52", defense: "43", spAtk: "60", spDef: "50", speed: "65",  types: "Fire",          sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/4.png",   moves: "Flamethrower,Scratch",    description: "" },
      { id: "7",   name: "Squirtle",  hp: "44", attack: "48", defense: "65", spAtk: "50", spDef: "64", speed: "43",  types: "Water",         sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/7.png",   moves: "Hydro Pump,Tackle",       description: "" },
      { id: "129", name: "Magikarp",  hp: "20", attack: "10", defense: "55", spAtk: "15", spDef: "20", speed: "80",  types: "Water",         sprite: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/129.png", moves: "Splash,Tackle",           description: "" },
    ];
    for (const p of fallbackPokemon) {
      await PokemonModel.updateOne({ id: p.id }, p, { upsert: true });
    }
  }

  // ── Seed default trainer "Red" ────────────────────────────────────────────
